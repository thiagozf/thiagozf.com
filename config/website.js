module.exports = {
  siteTitle: 'Thiago Zanivan',
  siteTitleAlt: "Thiago Zanivan's personal website :)",
  siteTitleShort: 'thiagozf',
  siteUrl: process.env.ROOT_URL || 'https://thiagozf.com',
  lang: 'en',
  pathPrefix: '/',
  ...
  userTwitter: '@thiagozf', // Twitter Username
  ogSiteName: 'Thiago Zanivan', // Facebook Site Name
  ogLanguage: 'en_US',
  ...
  rss: 'https://thiagozf.com/blog/rss.xml',
}
