...
const SubscribeFormWrapper = styled.div({
  ...
  backgroundImage:
    'linear-gradient(-213deg, #6146d9 0%, #3f2da4 100%), linear-gradient(32deg, rgba(255, 255, 255, 0.25) 33%, rgba(0, 0, 0, 0.25) 100%)',
  borderRadius: '5px',
})
...
function Subscribe({style, tags = [], header = 'Join the Newsletter'}) {
  ...
  const {pending, response, error} = useFetch({
    url: `https://app.convertkit.com/forms/1373370/subscriptions`,
    body: values,
  })
