...
Hello! I’m Thiago ([thiagozf] on GitHub). a developer with years of experience
across various tech domains — from building enterprise software and embedded
systems to experimenting with generative AI models and Web3 smart contracts.
When I’m not coding, you’ll likely find me hanging out with my dog, playing
video games, or working on side projects to explore new ideas.

For quite a while, I’ve been searching for a platform to record my progress,
share insights, and collaborate with other developers. This blog is my solution
— a space to document real-world challenges and dive into the topics I’m most
curious about.
...
saved me from hours more of frustration. At that moment, I truly grasped the
